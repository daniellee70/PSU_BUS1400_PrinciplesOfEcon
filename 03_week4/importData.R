...
write_rds(VIX_tbl, "data/VIX_tbl.rds")
...
write_rds(Treasury10_Yield_tbl, "data/Treasury10_Yield_tbl.rds")
...
write_rds(Yield_Spread_tbl, "data/Yield_Spread_tbl.rds")
...
write_rds(Home_Price_tbl, "data/Home_Price_tbl.rds")
...
write_rds(Recession_Dates_tbl, "data/Recession_Dates_tbl.rds")
...
write_rds(Inflation_tbl, "data/Inflation_tbl.rds")
...
write_rds(Unemployment_Rate_tbl, "data/Unemployment_Rate_tbl.rds")
...
write_rds(GDP_Growth_tbl, "data/GDP_Growth_tbl.rds")
...
write_rds(Consumer_Sentiment_tbl, "data/Consumer_Sentiment_tbl.rds")
